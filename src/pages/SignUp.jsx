                ...
                <input  type="text" id="name" value={name} onChange={onChange} placeholder='Full Name'
                    ...
                    <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
                        <p className='mb-6 '>Have an account?
                            <Link to="/sign-in" className='text-red-600 hover:text-red-700 transaction duration-200 ease-in-out ml-1'>Sign In</Link>
                            
                        </p>
                        <p>
                            <Link to="/forgot-password" className='text-blue-600 hover:text-blue-800 transaction duration-200 ease-in-out'>Forgot Password?</Link>
                        </p>
                    </div>
